...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2025 a las 22:17:11
...
--
-- Metadatos para la tabla auditoria_oficios
--

--
-- Metadatos para la tabla catalogo_personal
--
...
('root', 'alcaldia_control', 'catalogo_personal', '{\"sorted_col\":\"id DESC\"}', '2025-08-06 17:50:45');

--
-- Metadatos para la tabla configuracion
--
...
INSERT INTO `pma__table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'alcaldia_control', 'documentos', '{\"sorted_col\":\"`documentos`.`asunto` ASC\",\"CREATE_TIME\":\"2025-07-31 15:02:22\"}', '2025-08-06 17:46:41');
...
INSERT INTO `pma__table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'alcaldia_control', 'historial', '{\"sorted_col\":\"id DESC\"}', '2025-08-04 17:38:54');

--
-- Metadatos para la tabla historial_departamentos
--
...
INSERT INTO `pma__table_uiprefs` (`username`, `db_name`, `table_name`, `prefs`, `last_update`) VALUES
('root', 'alcaldia_control', 'historial_departamentos', '{\"sorted_col\":\"id DESC\"}', '2025-08-06 17:50:45');

--
-- Metadatos para la tabla jud_departamentos
--

--
-- Metadatos para la tabla logs_sistema
--
...
--
-- Metadatos para la tabla secuencia_oficios
--
...
--
-- Metadatos para la base de datos alcaldia_control
--
COMMIT;
